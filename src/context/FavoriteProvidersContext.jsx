...
// évite une nouvelle table côté serveur pour un simple réglage — voir la
// discussion de session, décision volontaire) : chaque appareil garde son
// propre choix, comme un réglage de navigateur.
const STORAGE_KEY = "bobine.favoriteProviders.v1";

const FavoriteProvidersContext = createContext(null);
...
export function FavoriteProvidersProvider({ children }) {
  const [favoriteProviderIds, setFavoriteProviderIds] = useState(loadInitialIds);
