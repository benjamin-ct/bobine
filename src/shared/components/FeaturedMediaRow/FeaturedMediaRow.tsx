  ...
  return (
    <div className={styles.row}>
      {items.map(({ item, badge }) => {
        ...
        // Le texte affiché vient toujours de t() (kind -> clé de
        // traduction), jamais de badge.label (français en dur, présent
        // uniquement pour que la logique pure des modules badge reste
        // testable indépendamment de react-i18next).
        const badgeLabel =
          badge.kind === "just_released"
