...
// sortie à afficher, libellé, date). Isolée de tmdb.js à dessein : ce
// module ne lit NI `import.meta.env.*` NI aucune API navigateur, il peut
// donc être importé tel quel par Node natif (scripts de vérification, voir
// scripts/verify-upcoming-badge.mjs) ET par le client Vite (tmdb.js le
// réexporte). Plus aucune copie à garder synchronisée : une seule source
// de vérité pour cette logique.
