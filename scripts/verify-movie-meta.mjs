...
// (src/api/movieMeta.js) : durée estimée, date de sortie ciné FR,
// formatage de date lisible, statut "au cinéma".
//
// Pas de framework de test dans ce repo (aucun Jest/Vitest) : script
// autonome, exécutable avec `node scripts/verify-movie-meta.mjs`, sur le
// même modèle que verify-upcoming-badge.mjs. Les fonctions sont IMPORTÉES
// directement depuis movieMeta.js (module pur, sans `import.meta.env` ni
