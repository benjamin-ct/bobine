...
check(
  ...
  { kind: "upcoming", label: "Prochainement", date: dateAt(29), seasonNumber: 1, episodeNumber: 1 }
);
...
check(
  ...
  { kind: "upcoming", label: "Prochainement", date: dateAt(2), seasonNumber: 1, episodeNumber: 1 }
);
...
check(
  ...
  { kind: "upcoming", label: "Prochainement", date: dateAt(13), seasonNumber: 2, episodeNumber: 1 }
);
...
check(
  ...
  { kind: "upcoming", label: "Prochainement", date: dateAt(10), seasonNumber: 2, episodeNumber: 1 }
);
...
check(
  ...
  { kind: "upcoming", label: "Prochainement", date: dateAt(6), seasonNumber: 2, episodeNumber: 5 }
);
